...
Open a terminal or command prompt and type :code:`pip install -U git+https://github.com/Cog-Creators/Red-DiscordBot@V3/develop#egg=Thinslaves[test]`
...
Assuming you installed V3 as outlined above, run :code:`Thinslaves-setup`
and provide the requested information. Once that's done, run Red
by doing :code:`Thinslaves <instance name> --dev` to start Red.
